...
import { dispatchOpencodeFetch } from "./opencode-fetch.js";
...
export function createOpencodePlugin(def) {
  const opencodeProvider = def.opencodeProvider || def.id;
        ...
        loader: async function () {
          return {
            ...
            fetch: function (req, init) {
              ...
              return dispatchOpencodeFetch(def, request, process.env, ctx);
            },
          };
        },
      },
